...
const Upload = ({ setImg }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setImg((prev) => ({ ...prev, isLoading: false, dbData: uploadResponse }));
    } catch (error) {
      // Handle specific error types provided by the ImageKit SDK.
      if (error instanceof ImageKitAbortError) {
        console.error("Upload aborted:", error.reason);
        setImg((prev) => ({ ...prev, isLoading: false, error: error.reason }));
        ...
        setImg((prev) => ({ ...prev, isLoading: false, error }));
      }
    }
  };
  ...
  return (
    <>
      ...
      <label
        ...
        htmlFor="file"
      >
        <img src="src/assets/attachment.png" alt="" />
      </label>
      <input
        type="file"
        id="file"
